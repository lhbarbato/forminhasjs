...
const produtos = [
    ...
    { id: 11, nome: 'Forminha Azul Bebê',          cor: 'azul',       preco: 12.90, fotos: ['azul bebe.jpeg'],         descricao: 'Forminha artesanal azul bebê' },
    { id: 12, nome: 'Forminha Azul Claro',         cor: 'azul',       preco: 12.90, fotos: ['azul claro.jpeg'],        descricao: 'Forminha artesanal azul claro' },
