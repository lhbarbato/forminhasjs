...
const produtos = [
    ...
    { id: 11, nome: 'Forminha Azul Bebê',          cor: 'azul',       preco: 12.90, fotos: ['azul bebe.png'],         descricao: 'Forminha de seda na cor azul bebê' },
    { id: 12, nome: 'Forminha Azul Claro',         cor: 'azul',       preco: 12.90, fotos: ['azul claro.png'],        descricao: 'Forminha de seda na cor azul claro' },
    { id: 13, nome: 'Forminha Azul Escuro',        cor: 'azul',       preco: 13.90, fotos: ['azul escuro.png'],       descricao: 'Forminha de seda na cor azul escuro' },
    { id: 14, nome: 'Forminha Azul Marinho',       cor: 'azul',       preco: 13.90, fotos: ['azul marinho.png'],      descricao: 'Forminha de seda na cor azul marinho' },
    { id: 15, nome: 'Forminha Azul Petróleo',      cor: 'azul',       preco: 14.90, fotos: ['azul petroleo.png'],     descricao: 'Forminha de seda na cor azul petróleo' },
    { id: 16, nome: 'Forminha Azul Serenity',      cor: 'azul',       preco: 13.90, fotos: ['azul serenity.png'],     descricao: 'Forminha de seda na cor azul serenity' },
    { id: 17, nome: 'Forminha Azul Tiffany',       cor: 'azul',       preco: 14.90, fotos: ['azul tiffany.png'],      descricao: 'Forminha de seda na cor azul tiffany' },
